<!DOCTYPE html>
    ...
    <div class="list">
        <div style="padding-bottom: 5px; padding-top: 5px">
            <button class="button" onclick="window.location.href='http://localhost:8765/'">
            ...
            <?php
                ...
                $table = '<table class="table" border="1"><tr><th>Full Name</th><th>Native Name</th><th>Alpha Code2</th><th>Alpha Code3</th></tr>';
